...
const PROMPTS = {
  headlines: () =>
    `You are a news wire researcher briefing someone in Israel who follows Israeli politics/economics and world geopolitics/economics. Find the single most important CURRENT story right now plus 5 other notable current stories, exclusively from: ${SOURCES_ISRAEL} and ${SOURCES_WORLD}.
` +
    wrapInstruction(
      `{"main_headline":{"title":"string","dek":"2-sentence summary","source":"outlet","url":"real URL","category":"Israel Politics | Israel Economy | World Geopolitics | World Economy"},"stories":[{"title":"string","one_liner":"1 sentence","source":"outlet","url":"real URL","category":"short label"}]}
"stories" must have exactly 5 items, distinct from main_headline.`
    ),
  stock: () =>
...
export async function fetchHeadlines() {
  return callClaude("headlines", 3000);
}
